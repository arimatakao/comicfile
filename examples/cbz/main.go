...
const filePath = "file.cbz"

func main() {
	createMode := flag.Bool("c", false, "create file.cbz")
	readMode := flag.Bool("r", false, "read file.cbz")
	flag.Parse()
...
func create() error {
	chapter, err := comicfile.NewContainer(comicfile.CBZ_EXT)
	if err != nil {
		return err
	}
